      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-lg text-muted-foreground leading-relaxed space-y-6">
            <p>
              I'm a results-driven software developer and machine learning enthusiast passionate about transforming ideas into intelligent, reliable, and human-centric systems. Currently pursuing B.Tech in Computer Science and Engineering at IIT Bhubaneswar, I've built solutions across MERN stack development, predictive analytics, and cloud deployment while contributing to research that blends AI and education.
            </p>
            <p>
              I value efficiency, clarity, and purpose in every project—whether it's optimizing performance, simplifying user experience, or scaling architecture for impact. With hands-on experience at organizations like AlgoUniversity, Fox Trading, and the Asian Institute of Technology in Bangkok, I bring a strong balance of technical execution and strategic problem-solving.
            </p>
            <p>
